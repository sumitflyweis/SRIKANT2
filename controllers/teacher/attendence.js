...
exports.createAttendenceOfStudentByTeacher = async (req, res) => {
  try {
    ...
    return res.status(200).send({msg:savedAttendance});
  } catch (err) {
    console.error(err);
  }
};
...
exports.getMonthlyAttendance = async (req, res) => {
  ...
  try {
    ...
    res.status(200).json({msg:monthlyAttendance});
  } catch (error) {
...
exports.getAttendenceOfStudentByIdByTeacher = async (req, res) => {
  try {
    ...
    return res.status(200).send({msg:attendance});
  } catch (err) {
    console.error(err);
  }
};
...
exports.updateAttendenceOfStudentByTeacher = async (req, res) => {
  try {
    ...
    return res.status(200).send({msg:updatedAttendance});
  } catch (err) {
    console.error(err);
  }
};
...
exports.deleteAttendenceOfStudentByTeacher = async (req, res) => {
  try {
    ...
    return res.status(200).send({msg:deletedAttendance});
  } catch (err) {
    console.error(err);
  }
};
